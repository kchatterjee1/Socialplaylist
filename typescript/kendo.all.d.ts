...
declare module kendo.ui {
    ...
    class ContextMenu extends kendo.ui.Widget {
        ...
        close(element: string): kendo.ui.ContextMenu;
        ...
        open(element: string): kendo.ui.ContextMenu;
        open(element: Element): kendo.ui.ContextMenu;
        open(element: JQuery): kendo.ui.ContextMenu;
        ...
        show(x: number, y: number): kendo.ui.ContextMenu;
        show(x: Element, y: number): kendo.ui.ContextMenu;
        show(x: JQuery, y: number): kendo.ui.ContextMenu;
    }
